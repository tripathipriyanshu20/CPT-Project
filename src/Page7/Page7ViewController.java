...
public class Page7ViewController {
    ...
    void login(ActionEvent event) {
        ...
        try {
            ...
            pst=con.prepareStatement(" select * from evadminlogin where username=?");
            ...
            while(res.next()) {
                ...
                if(PASS.equals(password.getText())) {
                    ...
                    javafx.scene.Parent root= FXMLLoader.load(getClass().getResource("/Page4/Page4View.fxml"));
                    //OR
    ...
    void signup(ActionEvent event) throws IOException {
        javafx.scene.Parent root= FXMLLoader.load(getClass().getResource("/Page8/Page8View.fxml"));
        //OR
        //Parent root=FXMLLoader.load(getClass().getClassLoader().getResource("marks/card/MarksCard.fxml"));
        javafx.scene.Scene scene = new javafx.scene.Scene(root);
        javafx.stage.Stage stage=new javafx.stage.Stage();
    ...
    @FXML
    void initialize() {
        assert Username != null : "fx:id=\"Username\" was not injected: check your FXML file 'Page7View.fxml'.";
        assert password != null : "fx:id=\"password\" was not injected: check your FXML file 'Page7View.fxml'.";
