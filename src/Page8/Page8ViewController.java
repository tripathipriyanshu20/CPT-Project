...
public class Page8ViewController {
    ...
    void signup(ActionEvent event) {
        ...
        try {
            ...
            pst=con.prepareStatement(" insert into evadminlogin values(?,?,?,?)");
    ...
    @FXML
    void initialize() {
        assert username != null : "fx:id=\"username\" was not injected: check your FXML file 'Page8View.fxml'.";
        assert password != null : "fx:id=\"password\" was not injected: check your FXML file 'Page8View.fxml'.";
        assert email != null : "fx:id=\"email\" was not injected: check your FXML file 'Page8View.fxml'.";
        assert address != null : "fx:id=\"address\" was not injected: check your FXML file 'Page8View.fxml'.";
